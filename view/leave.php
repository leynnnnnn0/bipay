<div class="container flex flex-col gap-1 bg-white rounded-lg w-[750px]">
    ...
    <div class="container p-5 flex flex-col gap-4">
        <!--  First Row-->
        <h1 class="text-gray-800 font-medium text-md">Student Name</h1>
            ...
            <div class="container flex flex-col gap-4">
                <h1 class="text-gray-800 font-medium text-md">Gender</h1>
                    <div class="container flex flex-col gap-2">
                        ...
                        <label for="year" class="text-gray-500 text-xs">Gender</label>
                    </div>
                </div>
            </div>
<!--        here-->
    ...
    <div class="container flex justify-end items-center p-5 gap-3">
        <span class="cursor-pointer px-4 py-2 rounded-lg text-semibold text-sm border border-gray-500 text-gray-500">Cancel</span>
